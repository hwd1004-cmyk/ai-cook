        ...
        <div className="mx-auto max-w-4xl px-4 flex flex-col min-h-screen">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="leading-tight">
                  ...
                  <div className="sm:hidden mt-2">
                    <span className="inline-block text-[11px] px-2.5 py-1 rounded-full border border-neutral-200 bg-white/90 text-neutral-600 font-medium tracking-tight">
          ...
          <footer className="relative mt-10 text-center">
            ...
            <div className="text-xs text-neutral-500 space-y-1">
              <p>
                © {new Date().getFullYear()} <span className="font-medium text-neutral-600">AI-Cook</span> · 집밥을 더 쉽고 즐겁게
              </p>
